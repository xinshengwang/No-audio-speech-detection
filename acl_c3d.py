...
from utils.traintest import train_two
...
if __name__ == "__main__":
    ...
    parser.add_argument('--fusion_type',type=str,default='early',choices=['early','late','mixture'])
    ...
    for split_num in range(6):
        ...
        model = fusion.Early_fusion(args)

        if args.split == 'train':
            train_two(model,train_loader,val_loader,args)